...
define('OUTREACH_EVAL_SUGAR_MODULE',                'ST_OtrchEval');
...
//// 	2.0 NEW MODULES
// define('OUTREACH_RACE_SUGAR_MODULE',                '???');
// define('OUTREACH_TARGET_SUGAR_MODULE',              '???');
// define('OUTREACH_LANG2_SUGAR_MODULE',               '???');
// define('PARTICIPANT_AUTHORIZATION_SUGAR_MODULE',    '???');
// define('PROVIDER_ROLE_SUGAR_MODULE',                '???');
// define('SPEC_EUIPMENT_SUGAR_MODULE',                '???');
// define('SPECIMEN_PICKUP_SUGAR_MODULE',              '???');
// define('SPECIMEN_RECEIPT_SUGAR_MODULE',             '???');
// define('SPECIMEN_SHIPPING_SUGAR_MODULE',            '???');
// define('SPECIMEN_STORAGE_SUGAR_MODULE',             '???');
// define('SPECIMEN_INFO_SUGAR_MODULE',                '???');
// define('ENVIRONMENTAL_EQUIPMENT_INFO_SUGAR_MODULE', '???');
// define('ENV_EQUIPMENT_PROBLEM_LOG_SUGAR_MODULE',    '???');
// define('PARTICIPANT_CONSENT_SAMPLE_SUGAR_MODULE',   '???');
// define('PARTICIPANT_RECORD_VISIT_SUGAR_MODULE',     '???');
// define('PRECISION_THERMOMETER_CERT_SUGAR_MODULE',   '???');
// define('REFRIGERATOR_FREEZER_VER_SUGAR_MODULE',     '???');
// define('SAMPLE_RECEIPT_STORAGE_SUGAR_MODULE',       '???');
// define('SAMPLE_SHIPPING_SUGAR_MODULE',              '???');
// define('SRSC_INFO_SUGAR_MODULE',                    '???');
// define('SUBSAMPLE_DOC_SUGAR_MODULE',                '???');
// define('TRH_METER_CALIBRATION_SUGAR_MODULE',        '???');
// define('DRFT_THERM_VERIFICATION_SUGAR_MODULE',      '???');
// define('SAMPLE_RECEIPT_CONFIRM_SUGAR_MODULE',       '???');
