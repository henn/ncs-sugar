...
$dictionary['PLT_Participant'] = array(
  ...
  array (
    'required' => false,
    'name' => 'person_info_c',
    'vname' => 'LBL_PERSON_INFO',
    'type' => 'html',
    'massupdate' => 0,
    'comments' => '',
    'help' => 'Person Information Summary',
    'importable' => 'false',
    'duplicate_merge' => 'disabled',
    'duplicate_merge_dom_value' => '0',
    'audited' => false,
...
VardefManager::createVardef('PLT_Participant','PLT_Participant', array('basic','assignable'));