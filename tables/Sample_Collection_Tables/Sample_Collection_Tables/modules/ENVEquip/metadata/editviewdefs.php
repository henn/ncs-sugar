    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            'name' => 'samp_envequ_envequip_name',
          ),
          1 => 
          array (
            'name' => 'samp_prethr_envequip_name',
          ),
        ),
        4 => 
        array (
          0 => 
          array (
            'name' => 'samp_reffre_envequip_name',
          ),
          1 => 
          array (
            'name' => 'samp_sampre_envequip_name',
          ),
        ),
        5 => 
        array (
          0 => 
          array (
            'name' => 'samp_trhmet_envequip_name',
          ),
          1 => 
          array (
            'name' => 'samp_drfthe_envequip_name',
          ),
        ),
      ),
      'lbl_editview_panel1' => 
