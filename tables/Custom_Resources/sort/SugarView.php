...
class SugarView
{
    ...
    public function displayHeader()
    {
        ...
        if ( isset($topTabList) && is_array($topTabList) ) {
			...
			//************************* code modified by Johnny *****************************************
			//http://stackoverflow.com/questions/1092400/is-there-a-specific-smarty-function-to-order-alphabetically-an-array			
			$extraTopMenu = $groupTabs[$app_strings['LBL_TABGROUP_ALL']]['extra'];
			asort($extraTopMenu);
			
			$ss->assign("moduleExtraMenu",$extraTopMenu);
			//************************* end code modified by Johnny *****************************************
        }
