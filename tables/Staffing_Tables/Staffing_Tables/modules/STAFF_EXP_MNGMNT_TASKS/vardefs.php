...
$vardefs = array (
  ...
  array (
    ...
    array (
      ...
      'vname' => 'LBL_STAFF_EXP_MGMT_TASK_ID',
      'type' => 'varchar',
      'massupdate' => 0,
      'comments' => '',
      'help' => '',
    ...
    array (
      'required' => false,
      'name' => 'mgmt_task_type',
      'vname' => 'LBL_MGMT_TASK_TYPE',
      'type' => 'enum',
      'massupdate' => 0,
      'default' => 'NCS Management',
      'comments' => '',
      'help' => '',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
